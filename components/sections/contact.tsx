...
const PERKS = [
  ...
  "Честно скажу, нужны ли занятия",
  "Подберём удобный формат и время",
];
    ...
    <section id="contact" className="relative px-4 py-24 sm:py-28">
      <div className="relative mx-auto max-w-6xl overflow-hidden rounded-[2.5rem] bg-[hsl(16_22%_13%)] p-8 shadow-soft-lg ring-1 ring-white/10 sm:p-12 lg:p-16">
        ...
        <div className="relative grid items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            <Reveal>
              <h2 className="font-display text-3xl font-extrabold leading-tight tracking-tight text-foreground sm:text-4xl lg:text-[2.9rem]">
                Запишитесь на
                <br />
                <span className="shimmer-text">бесплатную диагностику</span>
              </h2>
            </Reveal>
            <Reveal delay={100}>
              <p className="mt-5 max-w-md text-base leading-relaxed text-foreground/70">
                Оставьте заявку — отвечу в течение дня, разберу ситуацию с речью
                ребёнка и подберём удобное время. Без обязательств.
              </p>
            </Reveal>
            <Reveal delay={180}>
          ...
          {/* Form card */}
          <Reveal delay={150}>
            <div className="rounded-[2rem] bg-card/90 p-6 shadow-soft-lg ring-1 ring-white/10 backdrop-blur-md sm:p-8">
              {sent ? (
                <div className="flex flex-col items-center py-10 text-center">
                  <span className="grid h-16 w-16 place-items-center rounded-2xl bg-mint/20 text-mint">
                  ...
                  <p className="mt-2 max-w-xs text-sm text-muted-foreground">
                    ...
                    логопеду, и он свяжется с вами в течение дня.
                  </p>
                </div>
              ) : (
